...
for r = max(1,center(1)-3*sigmax-rbegin):min(center(1)+3*sigmax-rbegin,gsize(1)) %r=1:gsize(1)
    for c = max(1,center(2)-3*sigmay-cbegin):min(center(2)+3*sigmay-cbegin,gsize(2)) %c=1:gsize(2)
