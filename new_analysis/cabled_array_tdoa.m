...
%try
    [loc_est,c_est,err,tdoa_mat] = loc_est_calib_testfn(zdatafilt,xdatafilt,ydatafilt,zdata,xdata,ydata,xpos,ypos,1,length(zdatafilt),FS,c_range,N,plotting,calib_act,noise_mat,plotmap,1);
%catch
%    disp('Skipping this...')
%end
